package com.simplilearn.Phase5_Project2;
	...
	public void invokeBrowser() {
		System.setProperty("webdriver.chrome.driver", "D:\\driver\\chromedriver_win32\\chromedriver.exe");
		 WebDriver driver = new ChromeDriver();
		  ...
		  driver.findElement(By.xpath("//*[@id='email_create']")).sendKeys("princekumar009000@gmail.com");
		  ...
		  driver.findElement(By.xpath("//*[@id='phone_mobile']")).sendKeys("12334556678");
